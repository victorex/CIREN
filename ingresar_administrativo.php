...
<body>
<hr>
<h2>Ingresar Administrativo</h2>
    <p>Ingrese los datos del nuevo Administrativo</p>
	<form method="post" action="ingresar_administrativo.php">
	<table>
	...
	$sql = "INSERT INTO administrativo VALUES('".$rut."');" ;
	$insercion = pg_query($conexion,$sql);		
